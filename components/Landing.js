    ...
    return (
        <>
            <div className="flex flex-col justify-between items-center mx-auto py-8 my-8">
              <h1 className="text-black text-4xl md:text-8xl font-serif text-left leading-10 ">Lido Network is a decentralized crypto Staking and Yield farming protocol on Polygon-Matic chain </h1>
            <img src="savings.svg" />
            ...
            <div className="mt-24  max-w-3xl mx-auto border-2 bg-purple-300 py-5 px-8 shadow-xl rounded-lg">
                ...
                <h2 className="font-sans font-normal">What is Lido for Polygon?</h2>
            ...
            <div className="mt-4  max-w-3xl mx-auto border-2 bg-purple-300 py-5 px-8 shadow-xl rounded-lg">
                ...
                {second && 
            <p className=" text-lg pt-6 pb-3">When staking with Lido for Polygon, users receive stMATIC tokens as soon as they submit MATIC. Lido will calculate the current stMATIC/MATIC ratio and send the correct amount to the user. MATIC tokens are then delegated across Polygon validators that are part of Lido for Polygon.</p>
        }
            </div>
            <div className="mt-4 mb-6  max-w-3xl mx-auto border-2 bg-purple-300 py-5 px-8 shadow-xl rounded-lg">
                <div className="flex justify-center items-center">
                <h2 className="font-sans font-normal">What is liquid staking ?</h2>
            ...
            <div className="mt-4 mb-6  max-w-3xl mx-auto border-2 bg-purple-300 py-5 px-8 shadow-xl rounded-lg">
                ...
                {fouth && 
            <p className=" text-lg pt-6 pb-3">You can claim rewards anytime. Rewards keeps growing every block
            </p>
        }
            </div>
            </div>
