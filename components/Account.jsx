...
export default function Account ({handleClick}) {
    ...
    return (
        ...
        <div className='flex flex-col items-between justify-center'>
          ...
          .map((x) => (
            <button 
            className=' text-gray-100 bg-orange-500 border border-gray-600  p-2 rounded-lg w-full' 
            key={x.id} onClick={() => connect(x)}>
              ...
              {isConnecting && x.id === pendingConnector?.id && ' (connecting)'}
                      ...
                      {/* <p className='py-3 text-center text-sm font-serif'>Please make sure you&apos;re on polygon mainnet</p> */}
            ...
            className='mt-24 mb-12 border-2 border-gray-400 text-gray-100 w-full py-3 rounded-lg text-lg font-semibold font-sans'
    ...
    {accountData &&
        <div className=''>
            <div className=''>
                <h2 className='text-gray-100'>NFT minting coming soon, follow socials now
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
            ...
            <Disclosure>
      <Disclosure.Button className="py-2 flex justify-evenly">
        <p className='text-gray-100'>Contact Us</p>
        <svg 
        xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
  <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
</svg>
      </Disclosure.Button>
      <Disclosure.Panel className="text-gray-100 flex flex-col">
                    <p>Twitter</p>
                    <p>Telegram</p>
                    <p>Admin</p>
      </Disclosure.Panel>
