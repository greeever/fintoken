...
const Table = () => {
    ...
    return (
        ...
        <div>
                                    ...
                                    <p className='font-mono font-xl text-left font-semibold pt-4 text-white'>Stake your LD to gain access to USDC Yield Pool while Earning staking rewards on your LD.
