                        ...
                        <div className='text-center pt-8'>
                           ...
                           >
                                <div className='flex items-center justify-between pb-4 px-2 mx-auto'>
                                    ...
                                    <input className='placeholder:pl-4 placeholder:text-gray-800 dark:placeholder:text-gray-100 dark:focus:bg-gray-800 bg-gray-200 border-2 border-gray-200 leading-tight focus:outline-none focus:bg-gray-100 appearance-none text-gray-900 placeholder:text-sm placeholder:font-semibold p-3 flex-1 inline-flex text-sm rounded-r-md focus:ring-inset dark:border-gray-700 dark:text-gray-900 dark:bg-gray-800 focus:ring-gray-100 rounded-xl' placeholder='input amount'
